...
// become very necessary for you to write a simple computer solution that will later be coded in C+
// + language to convert a number of distances in feet to miles, yards and feet. You should accept
// as input a distance in feet and display the equivalent in miles, yards and feet. If a term is zero, it
...
int main () {
    //Declaring variables
    int distance, feet, miles, yards, milesRem, yardsRem;
